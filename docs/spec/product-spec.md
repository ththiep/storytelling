...
> Status: Draft  
> Date: 2026-07-15  
> Inspired by: Monkey-style story experience (Read / Play / Talk)
...
| **Talk** | Oral reading / expression | Child reads aloud; app + parents listen and celebrate |
...
3. **Talk** — read aloud challenge  

Rules of thumb:

- Reading can unlock or warm up Play / Talk (optional gating TBD).
...
- ✅ Completion screen with “listen again” / “play game” / “talk”  
...
#### Talk v0 implementation slice

Talk starts without scoring so the experience feels safe for young children:
...
| Preview | Optional: first pages of Reading free; Play/Talk locked |
...
| % Reading → Talk started | Speaking loop |
...
1. **Play rounds** for page-order puzzle (chunk long stories)  
2. **Talk v1** — real mic capture and parent playback  
3. Optional Talk scoring / ASR after privacy and UX decisions  
...
1. Does Reading completion gate Play / Talk, or are modes freely choosable?  
2. Free vs paid: which modes are locked?  
3. Talk: parent thumbs-up enough for v1, or need ASR?  
...
- Navigation flow (Home → Hub → Reading / Play / Talk)
